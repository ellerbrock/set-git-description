# [set-git-description](https://www.npmjs.com/package/set-git-description)
...
_set git description from npm description_
...
`npm install --save set-git-description`

### install with yarn

`yarn add set-git-description`
